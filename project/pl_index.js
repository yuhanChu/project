...
!(function(document, undefined) {
        ...
        SOTool = {
            ...
            setPluginStack: function(a, b) {
                if (videoSdkTool.isArray(a))
                    for (var d = 0; d < a.length; d++) arguments.callee(a[d], b);
                else if (a.hasOwnProperty("name") &&
                    a.hasOwnProperty("url")) SOTool.PluginStack[a.name] = a.url, "http" != a.url.substr(0, 4) && (SOTool.PluginStack[a.name] = "https:" == window.location.protocol ? window.location.protocol + SOTool.PluginStack[a.name].replace(/{domain}/g, "s.yuntv.letv.com") : "http:" + SOTool.PluginStack[a.name].replace(/{domain}/g, "yuntv.letv.com"), SOTool.PluginStack[a.name] = SOTool.PluginStack[a.name].replace(/{LANG}/g, b));
    ...
    var DomainTool = function() {
        function a(a, b) { d.hasOwnProperty(a) && d[a].hasOwnProperty(b) && (a = d[a][b]);
            return a }

        function b(a, b) {
            var d = a;
            if ("https:" == window.location.protocol || "undefined" != typeof b && b) {
                if (-1 != a.indexOf("http://")) return d = a.split("://")[1], c.hasOwnProperty(d) && (d = c[d]), "https://" + d;
                c.hasOwnProperty(d) && (d = c[d]) }
            return d }
        var d = { "api.mms.lecloud.com": { en_US: "api.usmms.lecloud.com" }, "apple.www.letv.com": { en_US: "apple.us.www.letv.com" } },
            c = {
        ...
        return { getDomain: function(c, d, f) {
                var h = c,
                    h = "";
                if (-1 != c.indexOf("http://")) {
                    for (var h = c.substring(7), h = h.split(""), k = "", l = 0; l < h.length; l++)
                        if ("/" != h[l]) k += h[l];
                        else break;
                    h = c.replace("http://" + k, b("http://" + a(k, d), f)) } else h = b(a(c, d), f);
                return h } }
    }();
    ...
    var LangTool = function() {
        var a = !1,
            b;
        return { loadLang: a, toMessage: function(d, c, g) {
                if (a) return b.hasOwnProperty(g) ? { message: b[g] } : { message: g };
                SOTool.getPlugin("lang.message.plugin." + c, function(c) { c && (b = c, a = !0);
                    d() });
                return !1 }, ms: b } }();
    SOTool.shareObj("common.LangTool", LangTool);
    var videoSdkTool = function() {
        function a(a) {
            for (var b = [{ name: "ie", test: /msie/ }, { name: "opera", test: /opera/ }, { name: "firefox", test: /firefox/ }, { name: "safari", test: /safari.*(?!chrome)/ }, { name: "chrome", test: /chrome/ }, { name: "wph", test: /windows phone/ }, { name: "ps", test: /playstation/ }, { name: "uc", test: /ucbrowser|ucweb/ }, { name: "ps", test: /playstation/ }, { name: "xiaomi", test: /xiaomi/ }, { name: "qq", test: /qqbrowser/ }, { name: "weixin", test: /micromessenger/ }, { name: "360", test: /360browser/ }, { name: "baidu", test: /baidu/ }, {
                    name: "qqwebview",
                    test: / qq/
                }, { name: "sougou", test: /sougou/ }, { name: "liebao", test: /liebaofast/ }, { name: "letv", test: /eui browser/ }], c = "un", d = 0; d < b.length; d++) {
                var k = b[d];
        ...
        return {
                ...
                if ("" == c.device) {
                    ...
                    a: {
                        a = [{ name: "wph", test: /windows phone/ }, {
                            name: "ipad",
                            test: /ipad/
                        }, { name: "iphone", test: /iphone/ }, { name: "androidPad", test: /(?!.*mobile)android/ }, { name: "androidPhone", test: /android.*mobile/ }, { name: "android", test: /android/ }, { name: "pc", test: /windows/ }, { name: "mac", test: /macintosh|mac os x/ }];
                        for (var b = 0; b < a.length; b++) {
                            var f = a[b];
                            if (f.test.test(d)) { a = f.name;
                                break a } }
                        a = "un"
                    }
                    c.device = a
            ...
            getBrowser: function() { "" == c.br && (c.br = a(d));
                return c.br },
            ...
            getJS: function(a, b, c, d, k, l) {
                if ("undefined" != typeof a) {
                    ...
                    n.type =
                        "text/javascript";
                    k && (n.charset = k);
                    n.onload = n.onreadystatechange = function() { n.readyState && "loaded" != n.readyState && "complete" != n.readyState || (n = n.onreadystatechange = n.onload = n.onerror = null, clearTimeout(s), "function" == typeof b && b.call(d)) };
                    n.onerror = function() { n = n.onload = n.onreadystatechange = n.onerror = null;
                        clearTimeout(s); "function" == typeof c && c.call(d) };
                    n.src = a;
                    m.appendChild(n);
                    l || (l = 1E4);
                    s = setTimeout(function() { clearTimeout(s); "function" == typeof c && c() }, l)
                }
            },
            getJSON: function(a, b, c, d, k, l) {
                ...
                var z = function() {
                    ...
                    D = function() { z();
                        t >= B ? (clearTimeout(q), window[n] = null, c && c.call(this, null, { responseTime: u.now() - m, retryCount: t, error: v })) : setTimeout(A, C) },
                    A = function() {
                        z();
                        t++;
                        ...
                        r.onload = r.onreadystatechange = function(a) { r.onload = r.onreadystatechange = null;
                            clearTimeout(q) };
            ...
            getJSONbyAjax: function(a, b, c, d, k, l) {
                ...
                var u = k || 2,
                    r = l || 1E3,
                    v = function() { clearTimeout(0);
                        q && (q.onreadystatechange = null) },
                    w = function() { v();
                        n >= u ? (clearTimeout(0), c && c.call(this, null, { responseTime: s.now() - m, retryCount: n, error: t })) : setTimeout(x, r) },
                    x = function() {
                        v();
                        n++;
                        ...
                        q.onreadystatechange = function(a) {
                            4 == q.readyState && (200 == q.status ? (a = q.responseText, v(), t = -1, b.call(this, a, { responseTime: s.now() - m, retryCount: n })) :
                                w())
                        };
                        q.ontimeout = w;
                        q.open("GET", a, !0);
            ...
            cookie: function(a, b, c) {
                if ("undefined" != typeof b) { c = c || {};
                    ...
                    c = c.secure ? "; secure" : "";
                    document.cookie = [a, "=", encodeURIComponent(b), d, k, l, c].join("") } else {
                    b =
                        null;
                    if (document.cookie && "" != document.cookie)
                        for (c = document.cookie.split(";"), d = 0; d < c.length; d++)
                            if (k = c[d], k.substring(0, a.length + 1) == a + "=") { b = decodeURIComponent(k.substring(a.length + 1));
                                break }
                    return b
                }
                return null
            },
            setLocal: function(a, b, c) { "undefined" == typeof c && (c = !0);
                if (window.localStorage) try { localStorage.setItem(a, b) } catch (d) {}
                c && this.cookie(a, b, c) },
            getLocal: function(a, b) {
                "undefined" == typeof b && (b = !0);
                if (window.localStorage) try {
                    if (localStorage.getItem(a)) return localStorage.getItem(a) } catch (c) {}
                return b ?
                    this.cookie(a) : -1
            },
            num2Time: function(a) {
            ...
            clone: function(a) {
                ...
                if (a instanceof Array)
                    for (b = [], c = 0, d = a.length; c < d; c++) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c];
                else
                    for (c in b = {}, a) b[c] = "object" == typeof a[c] && null != a[c] ? arguments.callee(a[c]) : a[c];
                return b
            },
            isHttps: function() {
                try {
                    return "https:" == window.location.protocol } catch (a) {}
                return !1 },
            isArray: function(a) {
            ...
            split: function(a, b, c) { a = a.split(b);
                var d = [];
    ...
    var WIN = window,
        ...
        MD5 = function() {
            function a(a, b, c, d, l, m) { a = g(g(b, a), g(d, m));
        ...
        UiTool = {
            getTemplate: function(a, b, d, c) { "undefined" != typeof d && (d = d.replace(/{#}/g, c), b = b.replace(/{#}/g, c), UiTool.loadCss(d));
                d = (new Date).getTime();
            ...
            $E: function(a) { a = "string" == typeof a ? document.getElementById(a) : a;
            ...
            addEvent: function(a, b, d) {
                if (-1 != b.indexOf(",")) { b = b.split(",");
                    for (var c = 0, g = b.length; c < g; c++) {
                        var e = b[c];
                        if ("" == e) break;
                        a.attachEvent ? a.attachEvent("on" + e, d) : a.addEventListener(e, d, !1) } } else a.attachEvent ? a.attachEvent("on" + b, d) : a.addEventListener(b, d, !1) },
                ...
                if (null != a && "function" == typeof d && "undefined" != typeof b)
                    if (-1 != b.indexOf(",")) { b = b.split(",");
                        for (var c = 0, g = b.length; c < g; c++) {
                            var e = b[c];
                            if ("" == e) break;
                            a.addEventListener ? a.removeEventListener(e, d, !1) : a.attachEvent && a.detachEvent("on" + e, d) } } else a.addEventListener ? a.removeEventListener(b, d, !1) : a.attachEvent && a.detachEvent("on" + b, d) },
            getPos: function(a) {
                a = this.$E(a);
            ...
            preventDefault: function(a) { a ? a.preventDefault() : window.event.returnValue = !1 },
            turnEvent: function(a) {
                var b = { mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend", mouseover: "touchstart", mouseout: "-", click: "touchstart" };
            ...
            drag: function(a, b) {
                ...
                a["on" + c] = function(c) {
                    ...
                    function m() { a.releaseCapture ? a.releaseCapture() : window.captureEvents && window.captureEvents(Event.MOUSEMOVE | Event.MOUSEUP);
            ...
            getImgRealRect: function(a) {
                var b = a.width,
                    d = a.height; "undefined" != typeof a.naturalWidth && (b = a.naturalWidth, d = a.naturalHeight);
    ...
    var jsonTool = { isString: function(a) {
                return "string" === typeof a }, stringToJson: function(a) {
                if (this.isString(a)) try {
                    return window.JSON.parse(a) } catch (b) {
                    return {} } else return a }, isJson: function(a) {
                return a && "object" === typeof a && "Object" === a.constructor ? !0 : !1 }, jsonToString: function(a) {
                var b = "";
                try { b = window.JSON.stringify(a) } catch (d) { b = d }
                return b } },
        logTool = function() {
            var a = "",
                b = [];
    ...
    var ReportTool = function() {
            ...
            return {
                print: function(b, d) {
                    ...
                    a.getElementsByTagName("input")[1].onclick = function() { a.style.display = "none" };
                    e.value = d
                },
                report: function(a, g) { document.body.appendChild(b);
                    d.innerHTML = "";
                    d.action = a;
                    d.method = "post";
                    d.target = "submit";
        ...
        FlashPlayer = {
            ...
            check: function(a) {
                var b = "";
                if ("undefined" != typeof window.ActiveXObject || "ActiveXObject" in window) try { b = (new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version") } catch (d) {}
                if (window.navigator.plugins && window.navigator.plugins["Shockwave Flash"]) try { b = window.navigator.plugins["Shockwave Flash"].description, this.isEmdbed = !0 } catch (c) {}
                "" == b && (this.isSupportFlash = !1);
                for (var b = b.split(/\s+/), g = 0, e = b.length; g < e; g++) parseInt(b[g]) > a && (this.isSupportFlash = !0);
            ...
            create: function(a, b, d) {
                ...
                this.num++;
                var g = { bgcolor: "#000000", allowscriptaccess: "always", wmode: "Opaque", width: "100%", height: "100%", align: "middle", quality: "high", allowFullScreen: !0, version: 10 },
                    e;
                for (e in b) g[e] = b[e];
                g.flashvars = d;
                b = "";
                if (this.check(g.version)) {
                    if (this.isEmdbed)
                        for (e in d = ["<embed name='" + c + "'src='" + g.url + "' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' width='" +
                                g.width + "' height='" + g.height + "' ", " />"
                            ], b = "", g) "width" != e && "height" != e && "url" != e && (b += e + "='" + g[e] + "' ");
                    else
                        for (e in b = "", d = ["<object id='" + c + "' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,45,0' type='application/x-shockwave-flash' width='" + g.width + "' height='" + g.height + "'><param name='movie' value='" + g.url + "'/>", "</object>"], g) "width" != e && "height" != e && "url" != e && (b += "<param name='" + e + "' value='" + g[e] +
                            "'/>");
                    b = d.join(b)
        ...
        ClassTool = function() {
            ...
            return {
                inherits: function(a, d) {
                    function c() {}
                    try { c.prototype = d.prototype, a.prototype = new c, a.prototype.constructor = a, a.prototype.superClass = d.prototype } catch (g) { debugger } },
    ...
    var GlobalHandler = function() {
            ...
            return {
                ...
                getHttpsDomain: function(a) {
                    if ("https:" == window.location.protocol) { a = a.split("://")[1];
                        var b = { "yuntv.letv.com": "s.yuntv.letv.com", "ark.letv.com": "arkletv.lecloud.com", "api.letvcloud.com": "apiletv.lecloud.com", "sdk.lecloud.com": "sdkletv.lecloud.com" };
                ...
                checkPlayType: function() {
                    ...
                    switch (videoSdkTool.getDevice()) {
                        ...
                        case "android":
                            ...
                            for (var b = navigator.userAgent.toLowerCase(), g = 0; g < a.length; g++)
                                if (-1 != b.indexOf(a[g].toLowerCase())) return "mp4";
                            if (/samsung/i.test(b) && /weibo/i.test(b)) break;
                            if (document.createElement("video") && "" == document.createElement("video").canPlayType("application/x-mpegURL")) break;
                            return "ios" }
                    return "mp4"
                },
                def2Type: function(a, b) {
        ...
        PlayState = { PLAY: 0, PAUSE: 1, STOP: 2 },
        ERR = {
            PARAMS: "1",
            NOSTART: "2",
            INTERRUPT: "3",
    ...
    SOTool.shareObj("manager.ColorManager", function() {
        function a() { this.managerDsipayList = [];
            this.cList = [];
        ...
        a.prototype.setColor = function(a, c, g, e) {
            ...
            var f = this.managerDsipayList.indexOf(a); - 1 == f ? (this.managerDsipayList.push(a), this.cList.push({ display: a, key: c, type: g, alpha: e })) : (this.cList[f].key =
                c, this.cList[f].type = g, this.cList[f].alpha = e)
        };
        a.prototype.register = function(a) {
            for (var b in a) this.colorConfig.hasOwnProperty(b) && ("0x" == a[b].substr(0, 2) && (a[b] = a[b].substr(2)), "#" != a[b].substr(0, 1) ? this.colorConfig[b] = "#" + a[b] : this.colorConfig[b] = a[b]) };
        a.prototype.refresh = function(a) { this.register(a);
    ...
    var ClassObject = function() {
        ...
        a.prototype = {
            ...
            addEventListener: function(a, d, c, g) {
                ...
                if ("undefined" == typeof d) throw this.log(d), Error("handler is undefined"); "undefined" == typeof c && (c = this);
            ...
            removeEventListener: function(a, d, c) { this.hasOwnProperty("EventMap") || (this.EventMap = {});
                if (this.EventMap.hasOwnProperty(a))
                    for (var g = 0; g < this.EventMap[a].length; g++)
                        if (this.EventMap[a][g].fun == d && this.EventMap[a][g].target == c) { this.EventMap[a].splice(g, 1);
            ...
            log: function(a) { logTool.log(a, this) }
        };
        return a
    }();
    SOTool.shareObj("core.ClassObject", ClassObject);
    var Control = function() {
            function a(a, d) { this.init(a, d) }
            ClassTool.inherits(a, ClassObject);
            a.prototype.init = function(a, d) { this.facade = a;
                this.model = d };
            return a }(),
        Event = function() {
            return function() { this.type = arguments[0];
                this.args = arguments } }();
    ...
    var Facade = function() {
        ...
        a.prototype.init = function(a) { this.color = new b;
    ...
    var Proxy = function() {
            function a() {}
            ClassTool.inherits(a, ClassObject);
            a.prototype.load = function(a) { this.loader = new AutoLoader;
                this.isClose = !1;
            ...
            a.prototype.loadCmp = function(a, d) {!this.isClose && this.dispatchEvent(new Event(LoadEvent.LOADCMP, [a, d])) };
            a.prototype.loadError = function(a, d) {!this.isClose && this.dispatchEvent(new Event(LoadEvent.LOADERROR, [a, d])) };
            return a
        }(),
        Plugin = function() {
            function a() {}
            ...
            a.prototype.initPlugin = function(a, d, c) {
                ...
                if (this.REConf.hasOwnProperty(a.type))
                    if (d = this.REConf[a.type], d.hasOwnProperty("check"))
                        if ("function" == typeof d.check)
                            if (d.check()) this.load(a);
                            else a.onerror(d.err);
                else if (d.check) this.load(a);
                else a.onerror(d.err);
                else this.load(a);
            ...
            a.prototype.load = function(a) {
                ...
                SOTool.getPlugin(d.pl.name, function(c) {
                    if (c) d.pluginCmpFun(c);
                    else a.onerror({ code: 420, message: "\u63d2\u4ef6\u52a0\u8f7d\u9519\u8bef" }) }) };
            return a
        }(),
        View = function() {
            function a(a, d) { this.facade = a;
                this.model = d;
                this.init() }
            ClassTool.inherits(a, ClassObject);
            ...
            a.prototype.setUp = function(a, d, c) { "undefined" == typeof c && (c = "");
                c = SkinRender.SkinTpl[this.tplKey] || c;
                this.el = UiTool.$E(a);
                this.skin = new DisplayObject(this.el);
                a = UiTool.getTemplate(this.el, c);
                if (d)
                    for (d = 0; d < a.length; d++) this.el[a[d]] = new DisplayObject(this.el[a[d]]);
            ...
            a.prototype.show = function() { this.skin.setVisible(!0) };
            a.prototype.hide =
                function() { this.skin.setVisible(!1) };
            return a
        }();
    SOTool.shareObj("core.View", View);
    var DisplayObject = function() {
        function a(a, c) { this.init(a); "undefined" == typeof c && (c = window.CloudSdkPlugin.skinUuid);
            this.sid = c }
        var b = SOTool.getObj("common.ClassTool"),
            d = SOTool.getObj("core.ClassObject"),
            c = SOTool.getObj("common.UiTool");
        b.inherits(a, d);
        a.prototype.init = function(a) { this.el = a };
                    ...
                    case "canvas":
                        if ("img" == d)
                            if (this.renderCanvas) this.el.hasOwnProperty("renderOption") ?
                                this.el.renderOption = a : c.setCanvasColor(this.renderCanvas, a.color);
                            else {
                                ...
                                k.onload = videoSdkTool.bindFun(function() { l.getContext("2d").drawImage(k, 0, 0);
                                    c.setCanvasColor(l, this.el.renderOption.color);
                                    delete this.el.renderOption }, this);
                                k.src = b[2] }
                }
            }
        };
        a.prototype.addEventListener =
            function(a, b, d) { a = c.turnEvent(a); "-" != a && c.addEvent(this.el, a, b) };
        a.prototype.removeEventListener = function(a, b, d) { a = c.turnEvent(a);
            c.removeEvent(this.el, a, b) };
        a.prototype.drag = function(a) { c.drag(this.el, a) };
        a.prototype.setButtonMode = function(a) { this.el.style.cursor = a ? "pointer" : "default" };
        a.prototype.setEnabled = function(a) { this.el.style.pointerEvents = a ? "auto" : "none" };
        a.prototype.setVisible = function(a) {
            a ? (this.el.style.display = "block", this.setAttribute({ orgwidth: this.el.offsetWidth, orgheight: this.el.offsetHeight })) :
                this.el.style.display = "none"
        };
        a.prototype.getVisible = function() {
            return "none" != this.el.style.display };
        a.prototype.setWidth = function(a) { a += ""; - 1 != a.indexOf("%") ? this.el.style.width = a : this.el.style.width = a + "px" };
        a.prototype.getWidth = function() {
            return 0 == this.el.offsetWidth ? this.getAttribute("orgwidth") : this.el.offsetWidth };
        a.prototype.setHeight = function(a) { a += ""; - 1 != a.indexOf("%") ? this.el.style.height = a : this.el.style.height = a + "px" };
        a.prototype.getHeight = function() {
            return 0 == this.el.offsetHeight ? this.getAttribute("orgheight") :
                this.el.offsetHeight
        };
        a.prototype.setX = function(a) { a += ""; - 1 != a.indexOf("%") ? this.el.style.left = a : this.el.style.left = a + "px" };
        a.prototype.getX = function() {
            return this.el.offsetLeft };
        a.prototype.setY = function(a) { a += ""; - 1 != a.indexOf("%") ? this.el.style.top = a : this.el.style.top = a + "px" };
        a.prototype.getY = function() {
            return this.el.offsetTop };
        a.prototype.appendChild = function(a) { a.hasOwnProperty("el") && (a = a.el);
        ...
        a.prototype.html = function(a) { this.el.innerHTML = a };
        a.prototype.gethtml = function(a) {
            return this.el.innerHTML };
        a.prototype.setClassName = function(a) { a = a.split(" ").join(this.sid + " ");
            a += this.sid;
            this.el.className = a };
        a.prototype.hasClassName = function(a) { a = a.split(" ").join(this.sid + " ");
            a += this.sid;
        ...
        a.prototype.removeClassName = function(a) { a = a.split(" ").join(this.sid + " ");
            a += this.sid;
        ...
        a.prototype.removeAttribute = function(a) {
            if (videoSdkTool.isArray(a))
                for (var c = 0; c < a.length; c++) this.el.removeAttribute(a[c]);
    ...
    var DragBar = function() {
        function a(a, b, d) { this.init(a, d); "undefined" == typeof b && (b = window.CloudSdkPlugin.skinUuid);
            this.sid = b }
        var b = SOTool.getObj("common.ClassTool"),
            d = SOTool.getObj("core.ClassObject");
        SOTool.getObj("common.UiTool");
        b.inherits(a, d);
        a.prototype.init = function(a, b) { this.percent = 0;
            this.view = a;
            this.rect = { x: 0.5 * -this.view.el.sliderOver.getWidth(), y: this.view.el.sliderOver.getY(), w: this.view.el.trackBg.getWidth(), h: 0 };
            this.addEvents() };
        ...
        a.prototype.render = function(a) {};
        a.prototype.setPercent = function(a) { this.percent = a;
            this.updateView() };
        a.prototype.updateView = function(a) { a = this.percent * this.view.el.trackBg.getWidth();
        ...
        a.prototype.addEvents = function(a, b, d) {
            ...
            this.view.el.sliderOver.drag({
                ...
                onMove: function(a) { f.seekHanler.apply(f, [!1]) },
                onUp: function(a) { f.seekHanler.apply(f, [!0]);
                    f.isSeeking = !1 }
            })
        };
        a.prototype.seekHanler = function(a) { this.percent = (this.view.el.sliderOver.getX() - this.rect.x) / this.view.el.trackBg.getWidth();
            this.updateView();
    ...
    var AutoLoader = function() {
            ...
            a.prototype = {
                load: function(a, d, c, g) {
                    ...
                    var e = this,
                        ...
                        k = function() {
                            ...
                            e.log("load url:" + a);
                            videoSdkTool.getJSON(a, function(a, c) { f += c.retryCount;
                                d && d.call(g, a, { responseTime: videoSdkTool.now() - h, retryCount: f }) }, function(a, b) {
                ...
                load2: function(a, d, c, g) {
                    ...
                    var e = this,
                        ...
                        k = function() {
                            ...
                            var a = e.getRealUrl(e.urlList[0]);
                            e.log("load url:" + a);
                            videoSdkTool.getJSONbyAjax(a, function(a, c) { f += c.retryCount;
                                d && d.call(g, a, { responseTime: videoSdkTool.now() - h, retryCount: f }) }, function(a, b) {
                                1 < e.urlList.length ? (f += e.urlList[0].maxCount, e.urlList.shift(), e.delayID = setTimeout(k, e.urlList[0].retryTime)) :
                                    (f += b.retryCount, c && c.call(g, null, { responseTime: videoSdkTool.now() - h, retryCount: f }))
                            }, e.urlList[0].timeout, e.urlList[0].maxCount, e.urlList[0].retryTime)
                        };
                    k()
                },
                ...
                destroy: function() { clearTimeout(this.delayID) },
                log: function(a) { logTool.log(a, this) }
            };
            return a
        }(),
        Timer = function() {
            ...
            a.prototype = { start: function() { this.running = !0;
                    this.checkTime(!1) }, checkTime: function(a) {
                    var d = this;
                    clearTimeout(this.T);
                    if (a && (d.currentCount++, d.timerHandler.call(d.handlerThis), 0 < d.max && d.currentCount >= d.max)) { d.stop();
                        return }
                    d.T = setTimeout(function() { d.checkTime.call(d, !0) }, d.delay) }, stop: function() { this.running = !1;
                    clearTimeout(this.T) }, reset: function() { this.stop();
                    this.currentCount = 0 }, clear: function() { this.handlerThis = this.timerHandler = this.delay = null;
                    this.T = 0 } };
            return a
        }();
    ...
    var PlayerEvent = function() {
        return { EVENT: "playerEvent", INIT: "playerInit", VIDEO_AUTH_VALID: "videoAuthValid", VIDEO_DATA_START: "videoDataStart", VIDEO_DATA_CMP: "videoDataCmp", GSLB_START: "gslbStart", GSLB_CMP: "gslbCmp", VPH: "videoPageHide", VPS: "videoPageShow", WPH: "webPageHide", ERROR: "playerError", RESIZE: "playerResize", VIDEO_INFO: "videoInfo", FULLSCREEN: "fullscreen", PRESIZE: "resize", VIDEO_LIVESTOP: "videoLiveStop", VIDEO_INTERRUPT: "videoLiveInterupt", USER_INFO: "user_info", NEXT: "playNext" } }();
    SOTool.shareObj("event.PlayerEvent", PlayerEvent);
    var MediaEvent = function() {
        return { EVENT: "MediaEvent", CONNECT: "videoConnect", START: "videoStart", PLAY: "videoResume", STOP: "videoStop", COMPLETE: "video_complete", PAUSE: "videoPause", BUFFEREMPTY: "videoEmpty", BUFFEREFULL: "videoFull", SEEK: "videoSeek", SEEKEMPTY: "videoSeekEmpty", PLAYING: "videoPlaying", LODING: "videoLoading", METADATA: "MetaData", DURATION: "videoDuration", DEFSTART: "swapDefinition", ERROR: "videoError", VOL: "vol", REPLAY: "videoReplay" } }();
    SOTool.shareObj("event.MediaEvent", MediaEvent);
    var SkinEvent = function() {
        return { EVENT: "skinEvent", PLAY: "skinPlay", PAUSE: "skinPause", SETDEFINITION: "setDefinition", SEEK: "skinSeek", VOLUME: "skinVolume", FULLSCREEN: "skinFullScreen", REPLAY: "skinReplay" } }();
    ...
    var Model = function() {
            ...
            function e() { this.systemData = new a;
                this.config = new b;
                this.reportParam = {};
                this.clear() }
            e.prototype = {
                init: function(a) {
                    switch (this.platform) {
                        case "sdk":
                            ...
                            logTool.log("[Stat K]  model init:" + this.systemData.deviceId + "  _2017-02-07 11:01:09.701");
                ...
                uuid: function() {
                    if ("sdk" == this.platform) {
                        ...
                        if (this.videoSetting.hasOwnProperty("uuid") && 6 < this.videoSetting.uuid.length) return this.videoSetting.uuid } "" == this._uuid && (this._uuid = videoSdkTool.creatUuid());
                    return this._uuid + "_" + this.videoSetting.definitionCount },
                clearUuid: function() {
                    this._uuid =
                        ""
                },
                lc: function() { null == this._lc && (this._lc = videoSdkTool.creatUuid(), videoSdkTool.setLocal("lc", this._lc));
                    return this._lc },
                getTypeFrom: function() {
                    var a = videoSdkTool.getUrlParams("ch");
                    if (a) return a.toString();
                    try {
                        if ("" != this.userInfo().userId) return "bcloud_" + this.userInfo().userId } catch (c) {}
                    return "letv" },
                apprunid: function() {
        ...
        CloudVodProxy = function() {
            ...
            ClassTool.inherits(a, Proxy);
            a.prototype.load = function(a) { this.curTime = 0;
                this.superClass.load.call(this, a) };
            a.prototype.getRequestList = function() {
                for (var a = [], d = ["//106.39.244.239/", "//111.206.211.221/", "//223.95.79.18/"], e = {
                        cf: this.getCf(),
                        ran: this.getCurTime(),
                ...
                for (k = 0; k < d.length; k++) - 1 != a[0].url.indexOf("//api.letvcloud.com/") && (e = f.replace("//api.letvcloud.com/", d[k]), a.push({ url: e, timeout: 5E3, maxCount: 3, retryTime: 0 }));
                return a
            };
            ...
            a.prototype.getSpf = function() {
                var a = videoSdkTool.getDevice(),
                    b = { androidPhone: 0, iphone: 1, letvTv: 2, ipad: 3, androidPad: 4 };
            ...
            a.prototype.loadCmp = function(a, g) {
                if (!this.isClose) {
                    ...
                    if (0 == a.code) {
                        ...
                        var h = { buttonColor: "fault", progressBarColor: "active" },
                            f = {};
                        ...
                        for (var h = {}, l = 0; l < a.videoinfo.medialist.length; l++) {
                            ...
                            h[k] = {};
                            h[k].urls = [];
                            for (var n = 0; n < m.urllist.length; n++) h[k].urls.push(this.checkGslbUrl(BaseCode.decode(m.urllist[n].url)));
                    ...
                    } else "10071" == a.code ? (this.curTime = a.timestamp, this.reload()) : this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.VOD_MMSID_ANALY, message: a.message }, g]))
                }
            };
            a.prototype.reload = function() { this.unload();
                this.superClass.load.call(this) };
            a.prototype.checkGslbUrl = function(a) {
                switch (videoSdkTool.getDevice()) {
                    case "ipad":
                    case "iphone":
                        -1 == a.indexOf("&tss=ios&") && (a = -1 != a.indexOf("&tss=no&") ?
                            a.replace("&tss=no&", "&tss=ios&") : a + "&tss=ios")
                }
                return a
            };
            a.prototype.loadError = function(a, b) { this.isClose || this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.VOD_CONFIG_IO, errInfo: "url:" + this.getUrl() }, b])) };
            return a
        }(),
        CloudMmsProxy = function() {
            ...
            ClassTool.inherits(a, Proxy);
            a.prototype.getRequestList = function() {
                for (var a = [], d = [], e = DomainTool.getDomain("http://api.mms.lecloud.com/v2/mms/play",
                        this.model.config.lang), f = "cf uu vu format callback pageurl pver ran ver p pu pet userId utoken".split(" "), h = {}, k = 0; k < f.length; k++) {
                    var l = f[k];
            ...
            a.prototype.loadCmp = function(a, g) {
                if (!this.isClose) {
                    ...
                    if (0 == a.code) {
                        ...
                        f.watermark = a.playerinfo.watermark;
                        e.playerConfig.refresh(f);
                        var f = { buttonColor: "fault", progressBarColor: "active" },
                            h;
                        for (h in a.playerinfo.onoff) f.hasOwnProperty(h) && (a.playerinfo.onoff[f[h]] = a.playerinfo.onoff[h], delete a.playerinfo.onoff[h], h = f[h]), e.outConfig.hasOwnProperty(h) || (e.config[h] = a.playerinfo.onoff[h]);
                        ...
                        for (var k = {}, l = 0; l < a.videoinfo.medialist.length; l++) {
                            ...
                            k[h] = {};
                            k[h].urls = [];
                            for (var n = 0; n < m.urllist.length; n++) k[h].urls.push(m.urllist[n].url);
                            k[h].videoWidth = m.vwidth;
                            k[h].videoHeight = m.vheight;
                            k[h].gbr = m.gbr;
                            k[h].vtype = m.vtype;
                            k[h].definition = m.definition;
                            k[h].videoType = m.urllist[0].videotype;
            ...
            a.prototype.checkGslbUrl = function(a) {
                ...
                return a };
            a.prototype.loadError = function(a, b) { this.isClose || this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.VOD_CONFIG_IO }, b])) };
            return a
        }(),
        GslbProxy = function() {
            function a(a) { this.model = a }
            ClassTool.inherits(a, Proxy);
            a.prototype.getRequestList =
                function() {
                    var a = [],
            ...
            a.prototype.checkGslbUrl = function(a) {
                ...
                "mp4" == this.model.vodPlayType && -1 == a.indexOf("&tss=no&") && (a = -1 != a.indexOf("&tss=ios&") ?
                    a.replace("&tss=ios&", "&tss=no&") : a + "&tss=no");
                return a
            };
            a.prototype.loadCmp = function(a, d) {
                if (!this.isClose)
                    if (this.log("gslb data:" + jsonTool.jsonToString(a) + " time" + jsonTool.jsonToString(d)), 200 == a.status) { a.ercode = "0";
                        for (var c = [a.location], g = 0; g < a.nodelist.length; g++) a.nodelist[g].location != c[0] && c.push(a.nodelist[g].location);
                        this.dispatchEvent(new Event(LoadEvent.LOADCMP, c)) } else this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.GSLB_ANALY, message: "\u8c03\u5ea6\u9519\u8bef" }, d])) };
            a.prototype.loadError = function(a, d) { this.isClose || this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.GSLB_IO, errInfo: "url:" + this.getUrl() }, d])) };
            return a
        }(),
        Reporter = function() {
            function a() { this.lastTime = this.pt = 0;
                this.isStartPlay = this.isPauseRecord = !1;
                this.state = "";
                this.replaytype = 1 }

            function b(a) { this.model = a;
                this.reset() }
            var d = { envUrl: "http://apple.www.letv.com/env/", playUrl: "http://apple.www.letv.com/cloud_pl/", erUrl: "http://apple.www.letv.com/er/", VERSION: "3.7.5", heartTime: 6E4 },
                c = {
                    pc: {
                        value: 30,
                        sub: { value: 300 }
                    },
                    sdk: { value: 32, sub: { value: 321, ios: { value: 321, domain: "https://apple-www.le.com" }, android: { value: 322 } } },
            ...
            b.prototype = {
                ...
                replaceTestDomain: function() {
                    var a = "";
                    switch (videoSdkTool.getDevice()) {
                        case "pc":
                        case "mac":
                            a = "live" == this.model.playType ? "3bc0" : "3bf3";
                            break;
                        case "iphone":
                        case "ipad":
                            a = "live" == this.model.playType ? "3bd1" : "3bg4";
                            break;
                        case "androidPhone":
                        case "androidPad":
                        case "android":
                            a = "live" == this.model.playType ? "3be2" : "3bh5" }
                    for (var b in d) "string" ==
                        typeof d[b] && -1 !== d[b].indexOf("{###}") && (d[b] = d[b].replace(/{###}/g, a))
                },
                replaceDomain: function(a) {
                    if (a.hasOwnProperty("domain"))
                        for (var b in d) "string" == typeof d[b] && ("http" === a.domain.substr(0, 4) ? d[b] = d[b].replace(/^http:\/\/apple.www.letv.com/g, a.domain) : d[b] = d[b].replace(/apple.www.letv.com/g, a.domain)) },
                reset: function() { this.heartTimer && (this.heartTimer.stop(), this.heartTimer = null);
                    this.reportParam = new a },
                onStateChanged: function(a, b) {
                    b = jsonTool.stringToJson(b);
                    logTool.log("[Stat K \u65e5\u5fd7\u6570\u636e]  type:" +
                        a + " data:" + b);
                    switch (a) {
                        case "init":
                ...
                startHeartTimer: function() {
                    this.heartTimer ? this.heartTimer.running || (this.setDelay(), this.heartTimer.start()) : (this.heartTimer =
                        new Timer(d.heartTime, this, this.heartHanlder), this.setDelay(), this.heartTimer.start())
                },
                pauseHeadStat: function() { this.heartHanlder();
                ...
                pausePtStat: function(a) { "undefined" == typeof a && (a = !1);
                ...
                resumePtStat: function(a) { "undefined" == typeof a && (a = !1);
                    var b = videoSdkTool.now();
                    this.reportParam.lastTime = b;
                    a || (this.reportParam.isPauseRecord = !1) },
                checkValue: function(a, b) {
                    return "undefined" ===
                        typeof a || "" === a || null === a ? "undefined" === typeof b ? "-" : b : a
                },
                sendEnvStat: function() {
                    ...
                    "html5" == this.model.platform && (a += "&lc=" + this.checkValue(b.lc()), a += "&app_name=bcloud_h5");
                    "sdk" == this.model.platform && (a += "&auid=" + this.checkValue(b.auid()), a += "&app_name=0");
                    a += "&uuid=" +
                        this.checkValue(b.uuid());
                    ...
                    a +=
                        "&cs=" + encodeURIComponent(this.checkValue(b.systemData.cs));
                ...
                sendPlayStat: function(a, b) {
                    var c = d.playUrl,
                        ...
                        c =
                        c + ("&p1=" + this.checkValue(this.model.reportParam.p1)),
                    ...
                    "html5" == this.model.platform && (c += "&lc=" + this.checkValue(k.lc()), c +=
                        "&app_name=bcloud_h5");
                    ...
                    "live" == k.playType && (c += "&lid=" + this.checkValue(k.videoSetting.lid), c += "&sid=" + this.checkValue(k.videoSetting.sid),
                        c += "&ty=1", c += "&vlen=6000", k.videoSetting.hasOwnProperty("activityId") && (c += "&zid=" + this.checkValue(k.videoSetting.activityId)));
                    ...
                    this.model.videoSetting.hasOwnProperty("p") && (b || (b = {}), b.hasOwnProperty("py") ||
                        (b.py = {}), b.py.p = this.model.videoSetting.p);
                    ...
                    "play" ==
                    a && (c += "&pay=0", b && b.hasOwnProperty("cv") && (c += "&stc=" + encodeURIComponent(this.checkValue(videoSdkTool.objectParseToString(b.cv.stc))), c += "&joint=" + this.checkValue(b.cv.joint)));
                    c += "&prl=0";
                    ...
                    "sdk" != this.model.platform && (c += "&url=" + encodeURIComponent(this.checkValue(window.location.href)), c += "&ref=" + encodeURIComponent(this.checkValue(document.referrer)));
                ...
                sendErrorStat: function(a) {
                    ...
                    "html5" == this.model.platform && (b += "&lc=" + this.checkValue(c.lc()),
                    ...
                    "vod" == c.playType && (b += "&cid=" + this.checkValue(c.videoSetting.cid),
                        "" != c.videoSetting.pid && (b += "&pid=" + this.checkValue(c.videoSetting.pid)), b += "&vid=" + this.checkValue(c.videoSetting.vid));
                    ...
                    b += "&uuid=" +
                        this.checkValue(c.uuid());
                    b += "&apprunid=" + this.checkValue(c.apprunid());
                    b += "&r=" + Math.round((Math.random() + 1) * Math.pow(10, 11));
                    this.report(b)
                },
                report: function(a) { a = DomainTool.getDomain(a, this.model.config.lang);
                    if ("html5" == this.model.platform) { logTool.log("[Stat K]  url:" + a);
                        var b = new Image(1, 1);
                        b.onload = b.onerror = b.onabort = function() { b = b.onload = b.onerror = b.onabort = null };
                        b.src = a } "sdk" == this.model.platform && ExternalInterface.callSDK(this.model.systemData.os, "logRequest", { url: a }) }
            };
            return b
        }(),
        ModelHandler =
        function() {
            ...
            a.prototype.setUp = function(a, d) {
                if (this.model.config.hasOwnProperty("url")) {
                    ...
                    c.load() } else a.hasOwnProperty("uu") && a.hasOwnProperty("vu") ? (this.model.vodPlayType = GlobalHandler.checkPlayType(), this.vodproxy = "101" == this.model.videoSetting.p ? new CloudVodProxy(this.model) : new CloudMmsProxy(this.model), this.vodproxy.addEventListener(LoadEvent.LOADCMP,
                    this.gpcCmp, this), this.vodproxy.addEventListener(LoadEvent.LOADERROR, this.errorHanlder, this), this.vodproxy.load()) : this.dispatchEvent(new Event(LoadEvent.LOADERROR, [{ code: ERR.PARAMS }]))
            };
            a.prototype.destroy = function(a) { this.vodproxy && this.vodproxy.unload() };
            a.prototype.errorHanlder = function(a) { this.dispatchEvent(new Event(LoadEvent.LOADERROR, a.args[1])) };
            a.prototype.gpcCmp = function(a) { this.refreshLoadingData(a);
                this.dispatchEvent(new Event(LoadEvent.LOADCMP, a)) };
        ...
        BasePlayer = function() {
            function a() {}
            ClassTool.inherits(a, ClassObject);
            a.prototype.init = function() { this.playUrlList = [];
            ...
            a.prototype.onPlayFullHandler = function() { this.startPlay || (this.startPlay = !0, this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.START)), this.render && this.render.start());
            ...
            a.prototype.onPlayEmptyHandler = function() {
                ...
                a.startPlay && 3 != a.playState && (5 != a.playState ? (a.playState = 3, a.emptyST = setTimeout(function() { a.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.BUFFEREMPTY, a.getTime())) }, a.emptyDelay)) : (a.playState = 3, a.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.SEEKEMPTY, a.getTime()))))
            };
            a.prototype.onPlaStopHandler = function() { this.emptyST && clearTimeout(this.emptyST);
            ...
            a.prototype.onPlayHandler =
                function() { this.emptyST && clearTimeout(this.emptyST);
                    this.playState = 1;
                    this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.PLAY, this.getTime())) };
            a.prototype.onPauseHandler = function() { this.emptyST && clearTimeout(this.emptyST);
                this.playState = 2;
            ...
            a.prototype.onLoadIngHandler = function() { this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.LODING, this.getLoadPercent())) };
            a.prototype.onMetaDataHandler = function(a) {
                ...
                !this.mduration || 0 != a.duration && isFinite(a.duration) || (a.duration =
                    this.mduration);
                0 < this.videoWidth && 0 < this.videoHeight && !this.hasMetadata && (this.setSize(), this.hasMetadata = !0, this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.METADATA, { videoWidth: this.videoWidth, videoHeight: this.videoHeight, duration: this.duration })));
        ...
        H5SamplePlayer = function() {
            function a() {
                ...
                this.type = "video";
                this._videoRect = {};
                this.videoHandlerBack = function() { a.videoHandler.apply(a, arguments) }
            }
            var b = 0,
            ...
            a.prototype.destroy = function() { this.removeEvents();
                this.stream && this.stream.close();
                this.render && this.render.close() };
            a.prototype.setPoster = function(a) { this.videoEL.poster = a };
            a.prototype.setUp = function(a,
                d) {
                b++;
                var e = "LecoudPlayer" + (new Date).getTime() + "" + b,
                    f, h = ["preload", "controls", "width", "height"];
                ...
                this.config = a;
                this.isEndStartSeek = 0 < this.config.start ? !1 :
                    !0;
                ...
                a.hasOwnProperty("x5Type") && "h5" == a.x5Type && /android/.test(videoSdkTool.getDevice()) && (this.videoEL.setAttribute("x5-video-player-type",
                    "h5"), a.hasOwnProperty("x5Fullscreen") && (a.x5Fullscreen ? this.videoEL.setAttribute("x5-video-player-fullscreen", "true") : this.videoEL.setAttribute("x5-video-player-fullscreen", "false")));
            ...
            a.prototype.enableControls = function() { this.video.controls = !0 };
            a.prototype.disableControls = function() { this.video.controls = !1 };
            a.prototype.setContainer = function(a) { this.vArea = a };
            a.prototype.setLoop = function(a) {};
            a.prototype.hide = function(a) {
                this.isShow && (a ? this.videoBox.style.display = "none" : (this.tmpwidth = this.videoBox.style.width, this.tmpheight = this.videoBox.style.height, this.videoBox.style.width = "1px", this.videoBox.style.height = "1px", this.videoBox.style.left = "-1000px",
                    this.videoBox.style.top = "-1000px"), this.isShow = !1)
            };
            a.prototype.show = function() { this.isShow || (this.videoBox.style.display = "", this.videoBox.style.width = this.tmpwidth, this.videoBox.style.height = this.tmpheight, this.videoBox.style.left = "0px", this.videoBox.style.top = "0px", this.isShow = !0) };
            a.prototype.setSize = function() {
                this.display = 0 < this.outEl.offsetWidth & 0 < this.outEl.offsetHeight ? !0 : !1;
                this.setVideoRect();
                this.isShow && (this.config.dvideoSize ? this.display && (this.videoBox.style.width = "100%", this.videoBox.style.height =
                    "100%") : 0 < this.videoWidth && 0 < this.videoHeight & 0 < this.outEl.offsetWidth & 0 < this.outEl.offsetHeight && (this.videoBox.style.width = this._videoRect.width + "px", this.videoBox.style.height = this._videoRect.height + "px", this.videoBox.style.top = this._videoRect.y + "px", this.videoBox.style.left = this._videoRect.x + "px"));
            ...
            a.prototype.setVideoRect = function() {
                if ("pano" == this.renderType) this._videoRect = {
                    ...
                    this._videoRect = { x: 0.5 * (this.outEl.offsetWidth - a), y: 0.5 * (this.outEl.offsetHeight - b), width: a, height: b } }
            };
            ...
            a.prototype.videoHandler = function(a) {
                switch (a.type) {
                    case "error":
                        ...
                        this.video.error && this.video.error.code &&
                            (a.code = "49" + this.video.error.code);
                        this.errorHandler(a);
                        break;
                    case "playing":
                        if (!this.startPlay) this.onMetaDataHandler({ width: this.video.videoWidth, height: this.video.videoHeight, duration: this.video.duration });
                        this.autoSeek();
            ...
            a.prototype.autoSeek = function() {
                ...
                0 != a.config.start ? a.startPlay || a.isEndStartSeek ? a.isStartSeek = !0 : setTimeout(function() { a.isStartSeek = !0;
                    a.seek(a.config.start) }, 500) : a.isStartSeek = !0
            };
            ...
            a.prototype.play = function(a) {
                ...
                this.render.init({ type: a.type, video: this.videoEL, el: this.vArea, onstart: function() { b.log("\u6e32\u67d3\u5f15\u64ce\u521d\u59cb\u5316\u5b8c\u6bd5\uff0c\u56de\u8c03\u64ad\u653e, url:" + b.url);
                        b.prePlay(b.url, b.autoplay || a.play, a) }, onerror: function(a) { b.log("\u6e32\u67d3\u5f15\u64ce\u521d\u59cb\u5316\u5931\u8d25");
                        a.retryCdn = !1;
                        b.errorHandler(a) } })
            };
            a.prototype.prePlay =
                function(a, b, d) {
                    ...
                    f.stream.init({
                        ...
                        url: a,
                        config: d,
                        onstart: function() { f.log("\u64ad\u653e\u5f15\u64ce\u521d\u59cb\u5316\u5b8c\u6bd5\uff0c\u56de\u8c03\u64ad\u653e, url:" + f.url);
                            f.video = f.stream.getVideo();
                            f.addEvents();
                            f.video.src = f.url;
                            if (f.autoplay || play) f.video.load && f.video.load(), f.resume(d.callback) },
                        onerror: function(h) {
                            "flv" == h.message ? (d.useFlv = !1, f.stream.close(), f.prePlay(a, b, d)) : (f.log("\u64ad\u653e\u5f15\u64ce\u521d\u59cb\u5316\u5931\u8d25"),
                                h.retryCdn = !1, f.errorHandler(h))
                        }
                    })
                };
            a.prototype.resume = function(a) {
                ...
                if (this.video.play) {
                    ...
                    d && d.then ? (d.then(function(b) { a && a() }()), d["catch"] && d["catch"](function(a) { b.log(a) })) : a && a() } };
            a.prototype.pause = function() { this.video.pause() };
            ...
            a.prototype.changeurl =
                function(a) { this.url = a;
                    this.video.src = this.url;
                    this.config.start = this.getTime();
                    this.isEndStartSeek = 0 < this.config.start ? !1 : !0;
                    this.video.load();
                    this.resume() };
            a.prototype.setVol = function(a) { this.videoEL.volume = a };
            a.prototype.getVol = function() {
                return this.videoEL.volume };
            a.prototype.stop = function() { this.destroy() };
        ...
        StreamEngine = function() {
            function a(a) {}
            var b = { hls: { name: "media.mediaPlay.hls", check: function() {
                        return !0 }, err: { code: "", message: "" } }, flv: { name: "media.mediaPlay.flv", check: function() {
                        return !0 }, err: { code: "", message: "" } } };
            ClassTool.inherits(a, Plugin);
            a.prototype.init = function(a) {
                this.isStart = !1;
                this.getPlayType(a);
                this.options = a;
                "" == a.type ? (this.eg = a.video, a.hasOwnProperty("onstart") && a.onstart && a.onstart()) : (this.log("\u521d\u59cb\u5316\u64ad\u653e\u5f15\u64ce" + this.eg), this.eg ? a.type != this.eg.type ? this.eg =
                    a.video : this.eg.reset(a) : this.initPlugin(a, this.pluginOk, b))
            };
            a.prototype.getPlayType = function(a) { a.type = a.config.useFlv ? "flv" : a.config.useHls ? "hls" : "" };
            a.prototype.getVideo = function(a) {
                return this.eg };
            a.prototype.pluginOk = function(a) { a ? (this.eg = new a(this.options), this.eg.init()) : this.eg = null };
            a.prototype.start = function() { this.isStart || (this.isStart = !0) };
            a.prototype.close = function() {
                this.log("\u5173\u95ed\u64ad\u653e\u5f15\u64ce" + this.eg);
                this.eg && (this.eg.close ? this.eg.close() : (this.eg.pause && this.eg.pause(),
                    this.eg.src = ""), this.eg = null);
                this.isStart = !1
            };
        ...
        RenderEngine = function() {
            ...
            ClassTool.inherits(a, Plugin);
            a.prototype.init = function(a) { this.isStart = !1;
                this.options = a;
            ...
            a.prototype.pluginOk = function(a) {
                this.eg =
                    a ? new a(this.options) : null
            };
            a.prototype.start = function() { this.isStart || (this.isStart = !0, this.eg && this.eg.start()) };
            a.prototype.close = function() { this.log("\u5173\u95ed\u6e32\u67d3\u5f15\u64ce" + this.eg);
                this.eg && this.eg.close();
                this.isStart = !1 };
            a.prototype.setSize = function(a, b) { this.eg && this.eg.setSize(a, b) };
            return a
        }(),
        MediaPlayer = function() {
            function a(a) { this.init(a) }
            ClassTool.inherits(a, ClassObject);
            a.prototype.init = function(a) { this.time = 0;
                this.config = a };
            a.prototype.setUp = function(a, d) {
                ...
                for (var e = 0; e < g.length; e++) {
                    var f = g[e];!c.hasOwnProperty(f) && a.hasOwnProperty(f) && (c[f] = a[f]) }
                this.creatPlayer(c, d)
            };
            a.prototype.creatPlayer = function(a, d) { this.player && (this.player.removeEventListener(MediaEvent.EVENT, this.MediaHanlder, this), this.player.destroy(), this.player = null);
                this.player = this.getPlayer(a);
                this.player.init();
                this.player.setUp(a, d) };
            a.prototype.setMedia = function(a) {};
            a.prototype.hide = function(a) { this.player.hide(a) };
            a.prototype.show = function() { this.player.show() };
            a.prototype.setConfig = function(a) {};
            a.prototype.setContainer = function(a) { null != a && this.player.setContainer(a) };
            a.prototype.getPlayer = function(a) {
                return new H5SamplePlayer };
            a.prototype.startPlay = function(a) {
                var d = { start: 0, play: !1, type: "", callback: null },
                    c;
                ...
                this.player.play(a) };
            a.prototype.setSize = function() { this.player.setSize() };
            a.prototype.play = function(a) { this.player.resume(a) };
            a.prototype.setVol = function(a) { this.player.setVol(a);
                this.volume = a;
                this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.VOL, a)) };
            a.prototype.pause = function() { this.player.pause() };
            a.prototype.destroy = function() { this.closeVideo();
                this.loop = !1;
            ...
            a.prototype.seek = function(a) { 0 <= a && 0 >= a - this.player.duration && (this.player.seek(a), a < this.player.duration && this.player.resume()) };
            a.prototype.getBufferPercent = function(a) {
                return 1 };
            a.prototype.getLoadPercent = function(a) {
                return this.player.getLoadPercent() };
            a.prototype.setLoop = function(a) { this.loop = a;
            ...
            a.prototype.changeurl = function(a) { this.player.changeurl(a) };
            a.prototype.getVideoRect = function(a) {
                return this.player.getVideoRect(a) };
            a.prototype.replay = function() { this.player.seek(0);
    ...
    SOTool.shareObj("media.watermask", function() {
        function a(a) { this.init(a);
            this.model = a }
        ClassTool.inherits(a, ClassObject);
        a.prototype.init = function(a) { this.waterList = [];
        ...
        a.prototype.setUp = function(a) {
            ...
            var c = this;
            if (this.waterData)
                for (a = 0; a < this.waterData.length; a++) d =
        ...
        a.prototype.destroy = function(a, d) { this.clear();
            this.waterData = null };
    ...
    var PlayUrlProxy = function() {
            function a(a) { this.model = a }
            ClassTool.inherits(a, ClassObject);
            a.prototype.translate = function() { this.gslbLoader = new GslbProxy(this.model);
            ...
            a.prototype.gslbErr = function(a) { this.dispatchEvent(new Event(LoadEvent.LOADCMP, this.leUrlsHandler())) };
            a.prototype.leUrlsHandler = function(a) { a = videoSdkTool.clone(this.model.videoSetting.urls);
                for (var d = 0; d < a.length; d++) a[d] = this.gslbLoader.checkGslbUrl(a[d]);
                return a };
            return a
        }(),
        ReportPlayer = function() {
            function a() { this.superClass.constructor.apply(this, arguments) }
            ...
            a.prototype.setUp = function(a, d) { this.model.config.report && (this.model.videoSetting.errCode = 0, this.facade.addEventListener(PlayerEvent.EVENT, this.videoSateHandler, this)) };
            ...
            a.prototype.showLog = function() { ReportTool.print(logTool.getLog(), this.model.lc()) };
            a.prototype.getLog = function() {
                return logTool.getLog() };
            return a
        }(),
        AdCtrl = function() {
            function a() { this.up = this.isvip = 0;
                this.isTrylook = !1;
                this.pname = "";
            ...
            b.prototype.setUp = function(a, b) {
                ...
                if (g.model.config.hasOwnProperty("onPlayerReady"))
                    if ("function" != typeof g.model.config.onPlayerReady && (g.model.config.onPlayerReady = window[g.model.config.onPlayerReady]), "function" == typeof g.model.config.onPlayerReady) try {
                        var e = setTimeout(function() { g.startLeAd.call(g) }, 5E3);
                    ...
                    } catch (f) { g.startLeAd.call(g) } else g.startLeAd.call(g);
                    else g.startLeAd.call(g)
            };
            b.prototype.startLeAd = function() { this.checkAd() ? "undefined" == typeof H5AD || "function" != typeof H5AD ? videoSdkTool.getJS(SOTool.PluginStack.Ad, this.initAd, this.initAd, this, "utf-8") : this.initAd() : this.facade.dispatchEvent(new Event(AdEvent.EVENT, AdEvent.NOAD, "skip")) };
            b.prototype.checkAd = function() {
                return this.model.config.hasOwnProperty("letvad") && "0" == this.model.config.letvad.toString() ||
                    this.model.videoSetting.hasOwnProperty("ark") && "0" == this.model.videoSetting.ark.toString() ? !1 : !0
            };
            b.prototype.initAd = function(b, c) {
                function g(a, b) {
                    if (e.player) switch (a) {
                        case "playAD":
                            e.adList = b;
                            e.adList && 0 == e.adList.length ? setTimeout(function() { e.destroy();
                                e.facade.dispatchEvent(new Event(AdEvent.EVENT, AdEvent.NOAD)) }, 0) : (e.curAdIndex = 0, e.playAD(), e.facade.dispatchEvent(new Event(AdEvent.EVENT, AdEvent.HEADSTART)));
                            break;
                        case "stopAD":
                            setTimeout(function() {
                                e.destroy();
                                e.facade.dispatchEvent(new Event(AdEvent.EVENT,
                                    AdEvent.HEADEND))
                            }, 0);
                            break;
                        case "resumeAD":
                ...
                if ("undefined" != typeof H5AD && "function" == typeof H5AD) {
                    ...
                    f.cont =
                        this.videoOutEl.id;
                    "vod" == this.model.playType ? (f.islive = !1, f.cid = this.model.videoSetting.cid, f.vid = this.model.videoSetting.vid, f.mmsid = this.model.videoSetting.mmsid, this.model.videoSetting.hasOwnProperty("pid") && (f.pid = this.model.videoSetting.pid)) : "live" == this.model.playType && (f.islive = !0, f.sid = this.model.config.activityId);
                    f.ch = this.model.getTypeFrom();
                    f.ark = this.model.videoSetting.ark;
                    f.useui = 1;
                    this.model.videoSetting.hasOwnProperty("p") && (f.ext = "" == this.model.userData.userId ? this.model.videoSetting.p :
                        this.model.videoSetting.p + "|" + this.model.userData.userId);
                    500 > this.videoOutEl.clientWidth && (f.pname = "MPlayer");
                    e.H5AD.initAD(f, g)
            ...
            b.prototype.mediaHandler = function(a) {
                switch (a.args[1]) {
                    ...
                    case MediaEvent.COMPLETE:
                        ...
                        break;
                    case MediaEvent.ERROR:
                        this.H5AD.sendEvent("AD_ERROR", { curAD: this.curAd, curIndex: this.curAdIndex }), this.curAdIndex++, this.H5AD.destory(this.curAd), this.playAD()
                }
            };
            b.prototype.videoPlay = function() { this.player && this.player.play() };
            b.prototype.getTime = function() {
                return this.player ? this.player.getTime() : 0 };
            b.prototype.videoPause = function() { this.player && this.player.pause() };
            b.prototype.getVideoRect = function() {
                return this.player ? this.player.getVideoRect("wh") : { w: 0, h: 0 } };
            b.prototype.destroy = function() {
                this.player &&
                    (this.player.removeEventListener(MediaEvent.EVENT, this.mediaHandler, this), this.player.closeVideo(), this.player = null);
                try { this.H5AD && this.curAd && this.H5AD.destory(this.curAd) } catch (a) { this.log("ad error " + a) }
            };
            return b
        }(),
        SkinPlayer = function() {
            ...
            a.prototype.load = function(a) {
                ...
                if (b.model.config.skinnable) SOTool.getPlugin("view.skin", function(a) {
                    if (a) b.skinView = new a(b.facade, b.model), b.skinView.addEventListener(SkinEvent.EVENT,
                        b.skinHandler, b), b.skinView.setUp(b.el.skin);
                    else
                        for (a = 0; a < b.el.childNodes.length; a++)
                            if (b.el.childNodes[a] == b.el.skin) { b.el.removeChild(b.el.skin);
                                break }
            ...
            a.prototype.setStylebyConfig = function(a) {
                ...
                for (var e = 0; e < b.length; e++)
                    if (!a[b[e]])
                        ...
                        else SkinRender["setMedia" + b[e]](g, !1) };
            ...
            a.prototype.setSize = function() { this.display = 0 < this.el.offsetWidth && 0 < this.el.offsetHeight ? !0 : !1 };
            ...
            a.prototype.skinHandler = function(a) { this.facade.dispatchEvent(a) };
            a.prototype.shutDown = function() { this.skinView && this.skinView.shutDown() };
            a.prototype.videoSateHandler = function(a) { a.args[1] !== MediaEvent.LODING && a.args[1] != MediaEvent.PLAYING && this.log(a.args[1]);
            ...
            a.prototype.refreshPlayerInfo = function(a) { this.skinView && this.skinView.refreshPlayerInfo(a) };
            return a
        }(),
        VideoPlayer = function() {
            ...
            a.prototype.changeVideoInfo = function(a) {
                ...
                a = { uuid: this.model.uuid(), p1: this.model.reportParam.p1, p2: this.model.reportParam.p2, p3: this.model.reportParam.p3 };
            ...
            a.prototype.getDefaultConfig = function(a) { this.definition = this.model.videoSetting.defaultDefinition || this.model.videoSetting.definitionList[0];
            ...
            a.prototype.showPoster = function(a) {
                ...
                switch (this.model.config.posterType) {
                    ...
                    default:
                        b.addPoster() }
                if (-2 == b.model.config.posterType) b.mediaPlayer.show(), b.mediaPlayer.setPoster(b.getPosterUrl()), b.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VIDEO_AUTH_VALID));
                else if (this.model.config.skinnable || b.model.config.controls) "7" ==
                    ...
                    b.el.appendChild(b.playBtn), UiTool.addEvent(b.playBtn, "click", function(a) { b.startAuth.call(b) })
            };
            ...
            a.prototype.hidePoster = function(a) { this.poster && this.el && this.poster.parentNode == this.el && (this.el.removeChild(this.poster), this.poster = null);
            ...
            a.prototype.startAuth = function(a) {
                ...
                b.mediaPlayer.play(function() { b.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VIDEO_AUTH_VALID)) })
            };
            a.prototype.startPlay = function(a) {
                this.log("\u5f00\u59cb\u5c1d\u8bd5\u64ad\u653e");
                this.isStartPlay = !1;
            ...
            a.prototype.gslbCmp = function(a) { this.videoInfo.urls = a.args[1];
            ...
            a.prototype.gslbErr = function(a) { this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.ERROR, a.args[2])) };
            a.prototype.setAutoReplay = function(a) { this.mediaPlayer.setLoop(a) };
                    ...
                    case SkinEvent.PLAY:
                        if (this.model.config.onlyPic) {
                            var b =
                                this;
                            b.mediaPlayer.show();
                            setTimeout(function() { b.mediaPlayer.play() }, 10)
            ...
            a.prototype.getPlayerType = function() {
                return this.model.config.hasOwnProperty("pano") &&
                    "1" == this.model.config.pano || "1" == this.model.videoSetting.pano ? "pano" : ""
            };
            a.prototype.mediaHandler = function(a) {
                switch (a.args[1]) {
                    case MediaEvent.ERROR:
                        if ("vod" == this.model.playType && this.model.vodPlayType && "ios" == this.model.vodPlayType && a.args[2][0].retryCdn) { this.model.vodPlayType = "mp4";
            ...
            a.prototype.getPosterUrl = function(a) {
                return this.model.config.hasOwnProperty("pic") ? this.model.config.pic :
                    this.model.videoSetting.hasOwnProperty("pic") ? this.model.videoSetting.pic : ""
            };
            a.prototype.destroy = function(a) { this.facade.removeEventListener(SkinEvent.EVENT, this.skinSateHandler, this);
                this.facade.removeEventListener(PlayerEvent.EVENT, this.videoSateHandler, this);
            ...
            a.prototype.refreshPlayerInfo =
                function(a) { "7" == this.model.config.nskin && this.render();
                    this.water.setUp(this.mediaPlayer) };
            return a
        }(),
        GlobalPlayer = function() {
            function a() { this.superClass.constructor.apply(this, arguments) }
            ClassTool.inherits(a, Control);
            a.prototype.setUp = function(a) { this.player = a;
                this.addEvents() };
            a.prototype.addEvents = function() {
                var a = this;
                a.addVideoEvent = !1;
                ...
                a.fullChangeFun = videoSdkTool.bindFun(a.fullChange,
                    a);
                ...
                var d;
                ["webkit", "moz", "o", "ms"].forEach(function(a) { "undefined" != typeof document[a + "Hidden"] && (d = a) });
                UiTool.addEvent(document, d + "visibilitychange", function() {
                    "hidden" == document[d + "VisibilityState"] ? a.facade.dispatchEvent(new Event(PlayerEvent.EVENT,
                        PlayerEvent.VPH)) : "visible" == document[d + "VisibilityState"] && a.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VPS))
                })
            };
            a.prototype.videoSateHandler = function(a) {
                switch (a.args[1]) {
                    case PlayerEvent.INIT:
                        this.addVideoEvents() } };
            a.prototype.pageHide = function(a) { this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.WPH)) };
            a.prototype.fullChange = function() {
                this.model.videoSetting && (this.model.videoSetting.fullscreen = UiTool.isFullScreen(), this.model.videoSetting.fullscreen || (this.cancelFullscreen(),
                    this.resizeFun()), this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.FULLSCREEN, this.model.videoSetting.fullscreen)))
            };
            a.prototype.resize = function() { this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.PRESIZE)) };
            ...
            a.prototype.addVideoEvents =
                function(a) {
                    ...
                    var d = this;
                    d.addVideoEvent || (a.addEventListener("webkitbeginfullscreen", function() { d.model.videoSetting.fullscreen = !0;
                            d.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.FULLSCREEN, d.model.videoSetting.fullscreen)) }), a.addEventListener("webkitendfullscreen", function() { d.model.videoSetting.fullscreen = !1;
            ...
            a.prototype.skinSateHandler = function(a) {
                switch (a.args[1]) {
                    case SkinEvent.FULLSCREEN:
                        a = this.player.videoplugin.mediaPlayer.getVideoEl();
                        if (this.model.config.dfull && a && a.webkitEnterFullscreen && "chrome" != videoSdkTool.getBrowser()) { a.webkitEnterFullscreen();
                            break }
        ...
        ErrorPlayer = function() {
            ...
            a.prototype.show = function(a) {
                var d = this;
                d.error ? d.error.show(a, d.el, { api: d._api, model: d.model }) : SOTool.getPlugin("ErrorInfo", function(c) { c && (d.error = new c, d.error.show(a, d.el, { api: d._api, model: d.model })) }) };
            a.prototype.report = function() {};
            return a
        }(),
        Api = function() {
            function a(a, d, c) {
                "undefined" != typeof c.api[a] && (d[a] =
                    function() {
        ...
        H5Sdk = function() {
            ...
            a.prototype.pauseVideo =
                function() { this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT, SkinEvent.PAUSE)) };
            a.prototype.resumeVideo = function() { this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT, SkinEvent.PLAY)) };
            a.prototype.seekTo = function(a) { this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT, SkinEvent.SEEK, a)) };
            a.prototype.replayVideo = function() { this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT, SkinEvent.REPLAY)) };
            a.prototype.closeVideo = function() { this._pl.closeVideo() };
            a.prototype.setVolume = function(a) {
                this._pl.facade.dispatchEvent(new Event(SkinEvent.EVENT,
                    SkinEvent.VOLUME, a))
            };
            a.prototype.shutDown = function() { this._pl.shutDown() };
            a.prototype.startUp = function() { this._pl.startUp() };
            a.prototype.getBufferPercent = function() {
                return this._pl.videoplugin ? this._pl.videoplugin.mediaPlayer.getBufferPercent() : 0 };
            a.prototype.setDefinition = function(a) { a = GlobalHandler.def2Type(a, this._pl.model.definition2TypeObj);
            ...
            a.prototype.setVideoPercent = function(a) { this._pl.skinplugin.setVideoPercent(a) };
            a.prototype.getVideoPercent = function() {};
            a.prototype.setVideoScale = function(a) { this._pl.skinplugin.setVideoScale(a);
                return 0 };
            a.prototype.getVideoScale = function() {
                return 0 };
            a.prototype.resetVideoScale = function() { this._pl.skinplugin.setVideoScale(0);
                return 0 };
            a.prototype.fullVideoScale = function() { this._pl.skinplugin.setVideoScale(1) };
            a.prototype.setVideoRect = function(a) { this._pl.skinplugin.setVideoScale(a) };
            a.prototype.getLoadPercent = function() {
            ...
            a.prototype.setPlayerInfo = function(a) { this._pl.setPlayerInfo(a) };
                        ...
                        switch (videoSdkTool.getBrowser()) {
                            ...
                            default:
                                ...
                                for (c = 0; c < g.length; c++)
                                    if (g[c].test(d)) { a.dvideoSize = !1;
                                        break }
                                if (0 <= parseInt(a.posterType) && (g = [/cpu iphone os 6_/], a.skinnable))
                                    for (c = 0; c < g.length; c++)
                                        if (g[c].test(d)) { a.onlyPic = !0;
                                            break } }
                        a.soundVisible = !1;
                        b.soundVisible = !1;
                    case "ipad":
                        switch (videoSdkTool.getBrowser()) {
                            case "qqwebview":
                                d = navigator.userAgent.toLowerCase(); /cpu iphone os 8_/.test(d) && !a.mustAutoplay && (a.autoplay = "0");
                                break;
                            default:
                                a.mustAutoplay || (a.autoplay = "0") }
                        break;
        ...
        BaseH5Player = function() {
            function a() { this.init() }
            ClassTool.inherits(a, ClassObject);
            a.prototype.init = function() { this.api = new H5Sdk(this) };
            ...
            a.prototype.envCheck = function() {
                return "1" != this.model.config.pano || videoSdkTool.checkPano() ? !0 : (this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VIDEO_INFO, [{ code: ERR.NOSupport, message: Message.NoSupportPano }])), !1) };
            ...
            a.prototype.configHanlder = function(a, d) { PlayerConf.configConver(a, d);
                a.hasOwnProperty("p") && (this.model.videoSetting.p = a.p) };
            a.prototype.addEvents = function() { this.facade.addEventListener(SkinEvent.EVENT, this.skinHandler, this);
            ...
            a.prototype.dataCmp = function() { this.log("\u8bf7\u6c42GpC\u6210\u529f"); "0" == this.model.videoSetting.isdrm ? (this.setupPlayer(), this.vModelInit = !0, this.skinplugin.addEventListener(LoadEvent.LOADCMP, this.skinCmp, this), this.facade.color.register(this.model.config), this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VIDEO_DATA_CMP)), this.skinplugin.load()) : this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.ERROR, [{ code: ERR.VOD_CONFIG_DRM, message: Message.Drm }])) };
            a.prototype.skinCmp = function() { "0" == this.model.config.autoplay ? this.videoplugin.showPoster() : this.videoplugin.startAuth() };
            a.prototype.setupPlayer = function() { this.log("\u5f00\u59cb\u521b\u5efa\u64ad\u653e\u5668");
            ...
            a.prototype.creatVideo = function() { this.log("\u5f00\u59cb\u521b\u5efa\u89c6\u9891");
                this.videoplugin.startPlay(this.skinplugin.getVideArea()) };
            a.prototype.setupAdplugin = function() { this.model.record.as = videoSdkTool.now();
                this.log("\u5f00\u59cb\u8bf7\u6c42\u5e7f\u544a");
            ...
            a.prototype.videoHandler = function(a) {
                ...
                switch (a.args[1]) {
                    ...
                    case PlayerEvent.INIT:
                        ...
                        this.model.playerConfig.refresh({ pWidth: this.skinplugin.el.offsetWidth, pHeight: this.skinplugin.el.offsetHeight });
                        break;
            ...
            a.prototype.nextHandler = function(a) { a.args[2] && a.args[2].hasOwnProperty("nextvid") && "" != a.args[2].nextvid && this.playNewId({ vu: a.args[2].nextvid }) };
            ...
            a.prototype.closeVideo = function() { this.videoplugin.destroy() };
            a.prototype.shutDown = function() { this.destroy();
                this.addEvents();
                this.videoplugin && this.videoplugin.showPoster() };
            a.prototype.startUp = function() { this.log("call startUp -vModelInit:" + this.vModelInit);
                this.destroy();
            ...
            a.prototype.feedback = function(a) { "undefined" == typeof a && (a = {});
                a.type = "0";
        ...
        BlH5Player = function() {
            ...
            a.prototype.init = function() { this.superClass.init.apply(this, arguments);
                this.version = "H5_Vod_20170207_4.8.0" };
            a.prototype.setModelByEnv = function() {
            ...
            a.prototype.initPlugin = function() {
                SOTool.setPluginStack([{ name: "ErrorInfo", url: "//{domain}/p/{LANG}/plugin/errorRender.js" }, { name: "FeedbackInfo", url: "//{domain}/p/{LANG}/plugin/feedbackRender.js" }, { name: "PanoRender", url: "//{domain}/p/{LANG}/plugin/panoRender1.1.js" }, { name: "Ad", url: "//{domain}/p/{LANG}/plugin/a.js" }, { name: "lang.message.plugin.vod", url: "//{domain}/p/{LANG}/plugin/lang/lang_vod.js" }], this.model.config.lang);
                SOTool.preload("lang.message.plugin.vod",
                    "ErrorInfo")
            };
            return a
        }(),
        BlFlashPlayer = function() {
            function a(a) { this.minVer = a }
            a.prototype = {
                setUp: function(a, d) {
        ...
        CloudPlayer = function() {
            ...
            a.prototype = {
                ...
                setUp: function(a, d, c) { this.player.setUp.apply(this.player, arguments) },
                check: function(a) {
        ...
        LecloudVodPlayer = function() {
            function a(a, b) {
                ...
                a.hasOwnProperty("width") &&
                    (isNaN(a.width) ? -1 != d.indexOf("%") && (d = a.width) : d = a.width + "px");
            ...
            d.prototype.init = function(c, d, e) {
                ...
                if (e) {
                    var k = function(a) {
                        switch (a.args[1]) {
                            case PlayerEvent.INIT:
                                h.facade.removeEventListener(PlayerEvent.EVENT, k, this), c.hasOwnProperty("callback") && ("function" == typeof c.callback ? c.callback && c.callback(h.videoplugin.mediaPlayer.player.video) : c.callback && WIN[c.callback] && WIN[c.callback](h.videoplugin.mediaPlayer.player.video)) } };
                    h.facade && h.facade.addEventListener(PlayerEvent.EVENT,
                        k, this)
                }
            };
            return d
    ...
    if ("undefined" != typeof WIN.letvcloud_player_conf) {
        ...
        if (!WIN.letvcloud_player_conf.hasOwnProperty("posterType")) { WIN.letvcloud_player_conf.posterType = "-1";
        ...
        WIN.Util = { setRate: function(a) { p.sdk.setDefinition(a) }, getRate: function() {
